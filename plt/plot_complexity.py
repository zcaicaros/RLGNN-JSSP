...
plt.grid()
x = np.array(x_labels)
plt.plot(x[:obj0.shape[0]], obj1, color='tab:green', marker="o", label='RL-GNN')
plt.plot(x, obj1, color='tab:red', marker="s", label='RL-GNN-Re')
plt.plot(x, obj2, color='tab:blue', linestyle="--", marker="v", label='L2S-500')
